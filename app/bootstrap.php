...
spl_autoload_register(function ($class) {
    ...
    $path = __DIR__ . "/class/" . $data[count($data) - 1] . ".php";
    if (file_exists($path)) {
        require_once $path;
    }
});
...
// Регистрируем нужные переменные в Реестре
$appReg =  MyFortniteBundle\Registry::instance();
$appReg->setData('DBH', $DBH);
$appReg->setData('request', $_SERVER['REQUEST_URI']);
